  ...
  <div class="auth-container">
    ...
    <div class="auth-card">
      <form @submit.prevent="handleRegister">
        ...
        <button type="submit" class="btn-auth" :disabled="!isFormValid || loading">
...
.auth-container { display: flex; flex-direction: column; align-items: center; justify-content: center; min-height: 100vh; background-color: #ffffff; padding: 2rem 1rem; }
...
.auth-logo { width: 50px; height: auto; filter: brightness(0) invert(1); }
.auth-header h1 { font-size: 2rem; color: #1a1a1a; margin-bottom: 0.5rem; font-weight: 700; }
.auth-header p { color: #666; font-size: 1rem; }
.auth-card { background: white; padding: 2.5rem; border-radius: 16px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.05); width: 100%; max-width: 600px; border: 1px solid #f0f0f0; }
...
.input-wrapper .icon { position: absolute; left: 12px; width: 20px; height: auto; opacity: 0.6; }
...
.form-select { width: 100%; padding: 12px; border: 1px solid #eee; border-radius: 10px; background-color: #f9f9f9; font-size: 1rem; transition: all 0.3s ease; appearance: none; background-image: url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23999' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'%3e%3cpolyline points='6 9 12 15 18 9'%3e%3c/polyline%3e%3c/svg%3e"); background-repeat: no-repeat; background-position: right 1rem center; background-size: 1em; }
.input-wrapper input:focus, .form-select:focus { outline: none; border-color: #2ecc71; background-color: #fff; box-shadow: 0 0 0 3px rgba(46, 204, 113, 0.1); }
...
.password-criteria { list-style: none; padding: 0; margin: 0.75rem 0 0 0; font-size: 0.85rem; background-color: #f9f9f9; padding: 10px; border-radius: 8px; border: 1px solid #eee; }
.password-criteria li { margin-bottom: 0.25rem; display: flex; align-items: center; gap: 0.5rem; }
.password-criteria li.valid { color: #2ecc71; }
.password-criteria li.invalid { color: #e74c3c; }
.btn-auth { width: 100%; padding: 14px; background-color: #2ecc71; color: white; border: none; border-radius: 12px; font-size: 1rem; font-weight: 600; cursor: pointer; transition: background-color 0.3s; margin-top: 1rem; }
.btn-auth:hover { background-color: #27ae60; }
.btn-auth:disabled { background-color: #95a5a6; cursor: not-allowed; opacity: 0.7; }
.auth-footer { margin-top: 1.5rem; text-align: center; font-size: 0.9rem; color: #666; }
.link-auth { color: #2ecc71; text-decoration: none; font-weight: 600; }
