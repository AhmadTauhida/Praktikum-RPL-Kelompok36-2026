...
const fetchRecipes = async () => {
  try {
    ...
    const response = await axios.get('https://praktikum-rpl-kelompok36-2026-ul8w.vercel.app/api/resep', config)
...
const deleteRecipe = async (id) => {
  ...
  try {
    ...
    await axios.delete(`https://praktikum-rpl-kelompok36-2026-ul8w.vercel.app/api/resep/${id}`, config)
